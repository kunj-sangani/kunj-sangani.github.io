...
This blog will help enable SharePoint Spaces in modern sites.
 
Currently, the feature is in Preview mode but will be released for all tenants soon.
 
To Enable SharePoint Spaces in your site collection, please follow the below steps.

#### Note
This feature works with SharePoint Modern Site Collection and is available currently for targeted.
 
Go to SiteCollection Settings.
